                                ...
                                <div class="row space">
                                    ...
                                    <div class='input-group'>
                                        <span class="input-group-addon">
                                            ...
                                            <input type="text" id="cduAdesao" name="cduAdesao" class="form-control dinheiro" onkeyup="formatarMoeda(this)"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
								    ...
								    <div class="col-md-3">
                                        ...
                                        <div class='input-group'>
                                            ...
                                            <input type="text" id="mensalidade" name="mensalidade" class="form-control dinheiro" onkeyup="formatarMoeda(this)"/>
                                        </div>
                                    </div> 
                                    <div class="col-md-3">
                                        ...
                                        <div class='input-group'>
                                            ...
                                            <input type="text" id="servico" name="servico" class="form-control" onkeyup="formatarMoeda(this)"/>
                                        </div>
                                    </div> 
                                </div>
                                <div class="row space">
