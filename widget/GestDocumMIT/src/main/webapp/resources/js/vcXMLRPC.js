...
if (parent && parent.ECM && parent.ECM.workflowView && parent.ECM.workflowView.processDefinition) {
    ...
    WKNumState = WKNumStateField = parent.ECM.workflowView.processDefinition.currentMovto; // corrigir atividade e nÃ£o
    // movimento
}
...
if (!window.jQuery
    ...
    // Se o formulÃ¡rio nÃ£o tiver jQuery, ou carregÃ¡-lo apÃ³s o vcXMLRPC.js, ou o browser for menor/igual a IE9, Ã©
    // necessÃ¡ria a implementaÃ§Ã£o nativa para ajax.
